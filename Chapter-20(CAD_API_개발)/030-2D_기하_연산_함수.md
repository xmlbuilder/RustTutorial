...
```math
u=\frac{(v_1\cdot v_1)(v_0\cdot v_2)-(v_0\cdot v_1)(v_1\cdot v_2)}{\mathrm{denom}}
```
```math
v=\frac{(v_0\cdot v_0)(v_1\cdot v_2)-(v_0\cdot v_1)(v_0\cdot v_2)}{\mathrm{denom}}
```
...
mod tests {
    ...
    use nurbslib::core::maths::{on_determinant3_vectors, on_cull_doubles, on_cull_doubles_keep_canonical,
        on_factorial, on_get_sampling_2d, on_get_sampling_3d, on_offset_point, on_sort_doubles};
    use nurbslib::core::polygon2d::{on_is_point_inside_box, on_is_point_on_segment_2d,
        on_is_point_on_segment_2d_with_domain, on_is_polygon_convex, on_monotone_chain_2d, on_point_in_rectangle,
        on_point_in_triangle_2d, on_point_in_triangle_2d_scalars, on_quick_hull_2d, PointStatus};
...
```rust
    ...
    fn test_get_sampling_2d_basic() {
        ...
        assert_eq!(got.len(), 7);
        // 등간격 샘플링인지 (정확 등간격은 아닐 수 있으나 패턴 확인)
