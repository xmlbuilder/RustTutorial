...
- 해법:
$$
\begin{aligned}a&=d_1\cdot d_1,\quad b=d_1\cdot d_2,\quad c=d_2\cdot d_2\\ e&=d_1\cdot (p_2-p_1),\quad f=d_2\cdot (p_2-p_1)\\ \mathrm{denom}&=ac-b^2\\ s&=\frac{ec-fb}{\mathrm{denom}},\quad t=\frac{eb-fa}{\mathrm{denom}}\end{aligned}
$$
