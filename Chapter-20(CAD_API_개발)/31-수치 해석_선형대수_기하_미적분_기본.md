...
| ✅ 단위 벡터 도함수             | `test_matches_numeric_derivative`, `test_derivative_is_orthogonal_to_u`, `test_parallel_change_gives_zero`, `test_scale_invariance`, `test_zero_guard_for_tiny_v`, `test_axis_case` |
